(() => {
 ...
 /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */            _regeneratorRuntime = function _regeneratorRuntime() {
        ...
        function formRating() {
            ...
            function initRatings() {
                ...
                function setRatingActiveWidth() {
                    var index = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : ratingValue.innerHTML;
                    var ratingActiveWidth = index / .05;
                ...
                function setRating(rating) {
                    ...
                    var _loop = function _loop(_index3) {
                        var ratingItem = ratingItems[_index3];
                        ...
                        ratingItem.addEventListener("click", (function(e) {
                            ...
                            if (rating.dataset.ajax) setRatingValue(ratingItem.value, rating); else {
                                ratingValue.innerHTML = _index3 + 1;
                                setRatingActiveWidth();
                            }
                        }));
                    };
                    for (var _index3 = 0; _index3 < ratingItems.length; _index3++) _loop(_index3);
                }
                function setRatingValue(_x3, _x4) {
                    return _setRatingValue.apply(this, arguments);
                }
                function _setRatingValue() {
                    _setRatingValue = _asyncToGenerator(_regeneratorRuntime().mark((function _callee2(value, rating) {
        ...
        function watcher_typeof(o) {
            "@babel/helpers - typeof";
            return watcher_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(o) {
                return typeof o;
            } : function(o) {
                return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o;
            }, watcher_typeof(o);
        ...
        function _toPropertyKey(t) {
            ...
            return "symbol" == watcher_typeof(i) ? i : i + "";
        }
        function _toPrimitive(t, r) {
            if ("object" != watcher_typeof(t) || !t) return t;
            var e = t[Symbol.toPrimitive];
            if (void 0 !== e) {
                var i = e.call(t, r || "default");
                if ("object" != watcher_typeof(i)) return i;
            ...
            return _createClass(ScrollWatcher, [ {
                ...
                value: function scrollWatcherConstructor(items) {
                    ...
                    if (items.length) {
                        ...
                        var uniqParams = uniqArray(Array.from(items).map((function(item) {
                ...
                value: function scrollWatcherLogging(message) {
                    this.config.logging ? functions_FLS("[Наблюдатель]: ".concat(message)) : null;
                }
            }, {
        ...
        var inp = document.querySelector(".footer__newsletter__form__input");
        window.addEventListener("resize", (function(e) {
            if (document.documentElement.clientWidth < 1042) inp.placeholder = "email address"; else inp.placeholder = "Enter email address";
        }));
        window.addEventListener("load", (function(e) {
            if (document.documentElement.clientWidth < 1042) inp.placeholder = "email address"; else inp.placeholder = "Enter email address";
        }));
        window.addEventListener("scroll", (function(e) {
            var headerItems = document.querySelectorAll(".menu__link");
            var watchItems = Array.from(document.querySelectorAll("[data-watch]")).filter((function(element) {
                return element.getAttribute("data-watch").trim() !== "";
            }));
            for (var i = 0; i < headerItems.length; i++) {
                if (headerItems[i].getAttribute("data-goto") == watchItems[i].getAttribute("data-watch") && watchItems[i].classList.contains("_watcher-view")) headerItems[i].classList.add("td"); else headerItems[i].classList.remove("td");
